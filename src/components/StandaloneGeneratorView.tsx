      ...
      <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-4 border-b border-[#EAE6DF] pb-4">
        ...
        {selectedMedia && (
          <button
            ...
            className="px-4 h-9.5 rounded-full text-xs font-bold bg-[#FFFFFF] hover:bg-[#F7F3ED] text-gray-700 border border-[#EAE6DF] flex items-center gap-1.5 transition-colors cursor-pointer self-start sm:self-center"
          >
      ...
      {!selectedMedia ? (
        <div className="space-y-6">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="px-4 h-9 rounded-full text-xs font-bold bg-[#E94B35] hover:bg-[#D13E29] text-white flex items-center gap-1.5 cursor-pointer shadow-sm"
            >
          ...
          {mediaItems.length === 0 ? (
            <div className="p-16 text-center rounded-3xl bg-white border border-dashed border-[#EAE6DF] text-xs text-gray-400">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
              {mediaItems.map((item) => (
                <div
                  ...
                  className="group bg-white rounded-2xl border border-[#EAE6DF] overflow-hidden shadow-xs hover:border-[#E94B35] transition-all-fast cursor-pointer flex flex-col justify-between"
                >
                  <div className="aspect-square w-full relative overflow-hidden bg-[#FAF8F5]">
                    ...
                    <span className="absolute top-2.5 right-2.5 px-2 py-0.5 rounded bg-white/95 text-[#111111] text-[8px] font-bold uppercase tracking-wider shadow-sm border border-[#EAE6DF]">
                      {item.file_type}
                    </span>
                  </div>
                  <div className="p-3.5">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-stretch">
          ...
          <div className="lg:col-span-3 flex flex-col gap-4">
            <div className="p-4 rounded-2xl bg-white border border-[#EAE6DF] flex flex-col gap-3">
              ...
              <div className="aspect-square rounded-xl overflow-hidden bg-[#F7F3ED] relative border border-[#EAE6DF]">
                <img 
                ...
                <div className="absolute top-2 left-2 flex items-center gap-1">
                  <span className="px-2 py-0.5 rounded bg-black/60 backdrop-blur-xs text-white text-[8px] font-mono uppercase flex items-center gap-1">
                    {selectedMedia.file_type === 'video' ? <Video className="w-2.5 h-2.5 text-[#E94B35]" /> : <FileImage className="w-2.5 h-2.5 text-[#E94B35]" />}
          ...
          <div className="lg:col-span-6 flex flex-col gap-4">
            <div className="p-6 rounded-2xl bg-white border border-[#EAE6DF] flex flex-col gap-4 flex-1">
                      ...
                      <button
                        ...
                        className={`w-6 h-6 rounded-md text-[10px] font-bold flex items-center justify-center cursor-pointer transition-colors ${
                          activeVariationIdx === idx
                            ...
                            : 'bg-[#F7F3ED] text-gray-600 hover:bg-[#EAE6DF]'
                        }`}
                      >
                        {idx + 1}
                      </button>
              ...
              <div className="flex-1 flex flex-col">
                <textarea
                  ...
                  rows={10}
                  className="w-full flex-1 p-4 rounded-xl bg-[#F7F3ED]/50 border border-[#EAE6DF] text-sm text-[#111111] placeholder-gray-400 focus:outline-none focus:border-[#E94B35] focus:ring-1 focus:ring-[#E94B35] resize-none leading-relaxed custom-scrollbar disabled:opacity-50"
                />
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 pt-3 border-t border-[#EAE6DF]">
                {/* Platform */}
                <div className="space-y-1">
                  ...
                  <select
                    ...
                    className="w-full px-2.5 h-8.5 rounded-lg bg-[#F7F3ED] border border-[#EAE6DF] text-xs font-semibold text-[#111111] focus:outline-none focus:border-[#E94B35]"
                  >
              ...
              <div className="flex items-center justify-between gap-3 pt-2">
                <button
                  ...
                  disabled={isGenerating}
                  className="px-4.5 h-10 rounded-xl text-xs font-bold bg-[#F7F3ED] hover:bg-[#EAE6DF] text-gray-700 border border-[#EAE6DF] flex items-center gap-1.5 transition-colors disabled:opacity-50 cursor-pointer"
                >
                ...
                <div className="flex items-center gap-2">
                  <button
                    onClick={handleCopy}
                    className="px-3.5 h-10 rounded-xl text-xs font-bold bg-[#FFFFFF] hover:bg-[#F7F3ED] text-[#111111] border border-[#EAE6DF] flex items-center gap-1.5 transition-colors cursor-pointer"
                  >
                  ...
                  <button
                    onClick={handleSave}
                    className="px-5 h-10 rounded-xl text-xs font-extrabold bg-[#E94B35] hover:bg-[#D13E29] text-white shadow-sm flex items-center gap-1.5 transition-all duration-150 cursor-pointer border-none"
                  >
          ...
          <div className="lg:col-span-3 flex flex-col gap-4">
            <div className="p-6 rounded-2xl bg-white border border-[#EAE6DF] flex flex-col gap-5 flex-1">
              <h3 className="font-display text-lg font-black text-[#111111] tracking-tight flex items-center gap-2">
                <Send className="w-4 h-4 text-[#E94B35]" />
              ...
              <div className="space-y-3.5 flex-1">
                <div className="flex items-center gap-2.5 text-xs text-gray-700">
                  <CheckCircle2 className="w-4.5 h-4.5 text-[#10B981] fill-[#EBFDF5]" strokeWidth={2} />
              ...
              <div className="space-y-2 pt-4 border-t border-[#EAE6DF]">
                <button
                  ...
                  className="w-full h-11 rounded-xl text-xs font-extrabold bg-[#E94B35] hover:bg-[#D13E29] text-white flex items-center justify-center gap-1.5 shadow-sm transition-all duration-150 active:scale-[0.98] cursor-pointer border-none"
                >
                  <span>Schedule Post →</span>
                </button>
                <button
                  onClick={handleSave}
                  className="w-full h-10 rounded-xl text-xs font-bold bg-[#FFFFFF] hover:bg-[#F7F3ED] text-gray-700 border border-[#EAE6DF] flex items-center justify-center transition-colors cursor-pointer"
                >
