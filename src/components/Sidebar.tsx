...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <aside className="w-[240px] shrink-0 hidden md:flex flex-col border-r border-[#E2E6EC] min-h-[calc(100vh-4.5rem)] p-5 select-none bg-transparent justify-between">
      ...
      <nav className="space-y-1.5 flex-1">
          ...
          return (
            <button
              ...
              className={`w-full flex items-center gap-3.5 px-4 py-3.5 rounded-xl text-sm font-semibold tracking-tight transition-all-fast cursor-pointer border-none ${
                isActive
                  ? 'text-[#14137B] bg-[#EDEDF8] font-bold'
                  : 'text-[#555555] hover:bg-white/40 hover:text-[#111111]'
              }`}
            >
              <Icon 
                className={`w-4 h-4 ${
                  isActive ? 'text-[#14137B]' : 'text-[#888888]'
                }`} 
                strokeWidth={2}
              />
        ...
        {/* Separator */}
        <div className="h-px bg-[#E2E6EC] my-5 mx-2" />
            ...
            >
              ...
              {item.badge && (
                <span className={`text-[10px] font-bold px-2 py-0.5 rounded-full ${
                  isActive ? 'bg-[#14137B] text-white' : 'bg-[#E2E6EC] text-[#555555]'
                }`}>
                  {item.badge}
                </span>
              )}
      ...
      <div className="mt-auto bg-[#EDEDF8] rounded-2xl p-4 border border-[#C9C8E8] text-xs relative flex flex-col gap-2.5 text-left">
        ...
        <button
          ...
          className="w-full h-8.5 rounded-xl bg-[#14137B] hover:bg-[#0E0D57] text-white text-[11px] font-extrabold flex items-center justify-center gap-1.5 cursor-pointer border-none shadow-xs mt-0.5 transition-all"
        >
