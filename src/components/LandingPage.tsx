...
export const LandingPage: React.FC<LandingPageProps> = ({ onStartCreating, onLogin }) => {
  ...
  return (
    <div className="min-h-screen bg-[#F5F7FA] text-[#111111] font-sans antialiased selection:bg-[#14137B] selection:text-white">
      ...
      <header className="sticky top-0 z-40 bg-[#F5F7FA]/90 backdrop-blur-md border-b border-[#E2E6EC]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-8 text-sm font-semibold text-gray-700">
            <button onClick={() => scrollToSection('how-it-works')} className="hover:text-[#14137B] transition-colors cursor-pointer bg-transparent border-none">
              How It Works
            </button>
            <button onClick={() => scrollToSection('features')} className="hover:text-[#14137B] transition-colors cursor-pointer bg-transparent border-none">
              Features
            </button>
            <button onClick={() => scrollToSection('brand-voice')} className="hover:text-[#14137B] transition-colors cursor-pointer bg-transparent border-none">
              Brand Voice
            </button>
            <button onClick={() => scrollToSection('pricing')} className="hover:text-[#14137B] transition-colors cursor-pointer bg-transparent border-none">
              Pricing
            </button>
            <button onClick={onLogin} className="hover:text-[#14137B] transition-colors cursor-pointer bg-transparent border-none text-[#111111] font-bold">
              Log In
            </button>
          </nav>
          ...
          <div className="hidden md:flex items-center gap-3">
            <button
              ...
              className="inline-flex items-center gap-2 px-5 h-11 rounded-full text-xs font-extrabold bg-[#14137B] hover:bg-[#0E0D57] text-white shadow-sm transition-all duration-150 active:scale-[0.98] cursor-pointer border-none"
            >
        ...
        {mobileMenuOpen && (
          <div className="md:hidden bg-white border-b border-[#E2E6EC] px-6 py-6 space-y-4 animate-fadeIn">
            ...
            <div className="pt-4 border-t border-[#E2E6EC] flex flex-col gap-3">
              <button
                onClick={onLogin}
                className="w-full py-2.5 rounded-xl text-xs font-bold text-gray-800 bg-[#F5F7FA] border border-[#E2E6EC]"
              >
                Log In
              </button>
              <button
                onClick={onStartCreating}
                className="w-full py-3 rounded-xl text-xs font-extrabold bg-[#14137B] text-white shadow-sm flex items-center justify-center gap-2 border-none"
              >
                <span>Start Creating</span>
        ...
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-6 space-y-8 text-left">
            <h1 className="font-display text-4xl sm:text-6xl font-black text-[#111111] leading-[1.08] tracking-tight">
              ...
              <span className="text-[#14137B] italic font-display">worth posting.</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 pt-2">
              <button
                onClick={onStartCreating}
                className="h-13 px-8 rounded-full text-sm font-extrabold bg-[#14137B] hover:bg-[#0E0D57] text-white shadow-md flex items-center justify-center gap-2.5 transition-all duration-150 active:scale-[0.98] cursor-pointer border-none"
              >
                <span>Start Creating</span>
              ...
              <button
                ...
                className="h-13 px-7 rounded-full text-sm font-bold bg-white hover:bg-[#F5F7FA] text-[#111111] border border-[#E2E6EC] flex items-center justify-center transition-colors cursor-pointer"
              >
                See How It Works
              </button>
            </div>
      ...
      <section className="py-12 bg-white border-y border-[#E2E6EC]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
            
            <div className="p-4 space-y-1">
              <span className="text-xs font-extrabold uppercase tracking-widest text-[#14137B]">01 — CONTENT</span>
              <p className="text-sm font-bold text-[#111111]">Google Drive Assets</p>
            </div>

            <div className="p-4 space-y-1 border-l border-[#E2E6EC]">
              <span className="text-xs font-extrabold uppercase tracking-widest text-[#14137B]">02 — ENGINE</span>
              <p className="text-sm font-bold text-[#111111]">CaptionDrive AI</p>
            </div>

            <div className="p-4 space-y-1 border-l border-[#E2E6EC]">
              <span className="text-xs font-extrabold uppercase tracking-widest text-[#14137B]">03 — VOICE</span>
              <p className="text-sm font-bold text-[#111111]">On-Brand Copy</p>
            </div>

            <div className="p-4 space-y-1 border-l border-[#E2E6EC]">
              <span className="text-xs font-extrabold uppercase tracking-widest text-[#14137B]">04 — PUBLISH</span>
      ...
      <section className="py-20 sm:py-28 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto text-center">
        <div className="max-w-3xl mx-auto space-y-4">
          <span className="text-xs font-extrabold uppercase tracking-widest text-[#14137B]">The Pain Point</span>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 mt-16 text-left">
          ...
          <div className="p-6 rounded-3xl bg-white border border-[#E2E6EC] shadow-xs space-y-3">
            <div className="w-8 h-1 rounded-full bg-[#66D100]" />
      ...
      {/* 5. HOW IT WORKS */}
      <section id="how-it-works" className="py-20 bg-white border-y border-[#E2E6EC]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
          
          <div className="text-center max-w-2xl mx-auto space-y-3">
            <span className="text-xs font-extrabold uppercase tracking-widest text-[#14137B]">Simple 3-Step Process</span>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            {/* Step 1 */}
            <div className="p-8 rounded-3xl bg-[#F5F7FA]/60 border border-[#E2E6EC] space-y-4 text-left">
              <span className="text-xs font-extrabold tracking-wider text-[#14137B] uppercase">01 — CONNECT</span>
              ...
              <div className="pt-4 flex items-center gap-2 text-xs font-bold text-[#14137B]">
            ...
            {/* Step 2 */}
            <div className="p-8 rounded-3xl bg-[#F5F7FA]/60 border border-[#E2E6EC] space-y-4 text-left">
              <span className="text-xs font-extrabold tracking-wider text-[#14137B] uppercase">02 — CREATE</span>
            ...
            {/* Step 3 */}
            <div className="p-8 rounded-3xl bg-[#F5F7FA]/60 border border-[#E2E6EC] space-y-4 text-left">
              <span className="text-xs font-extrabold tracking-wider text-[#14137B] uppercase">03 — PLAN</span>
      ...
      <section id="brand-voice" className="py-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-6 space-y-6 text-left">
            <span className="text-xs font-extrabold uppercase tracking-widest text-[#14137B]">Core Differentiator</span>
            <h2 className="font-display text-3xl sm:text-5xl font-black text-[#111111] leading-tight tracking-tight">
              AI can write a caption. <br />
              <span className="text-[#14137B] italic font-display">CaptionDrive learns how YOUR brand talks.</span>
            </h2>
            ...
            <div className="p-6 rounded-2xl bg-white border border-[#E2E6EC] space-y-3">
              <div className="flex items-center justify-between text-xs border-b border-[#E2E6EC] pb-2">
                <span className="font-extrabold text-[#111111]">Sample Profile: Glow Beauty</span>
                <span className="text-[#14137B] font-bold">Active Voice</span>
              </div>
              <div className="flex flex-wrap gap-2 pt-1">
                <span className="px-2.5 py-1 rounded-md bg-[#EDEDF8] text-[#14137B] text-xs font-bold">Friendly</span>
                <span className="px-2.5 py-1 rounded-md bg-[#EDEDF8] text-[#14137B] text-xs font-bold">Educational</span>
                <span className="px-2.5 py-1 rounded-md bg-[#EDEDF8] text-[#14137B] text-xs font-bold">Conversational</span>
              </div>
            </div>

            <button
              onClick={onStartCreating}
              className="inline-flex items-center gap-2 px-6 h-12 rounded-full text-xs font-extrabold bg-[#14137B] hover:bg-[#0E0D57] text-white shadow-sm transition-all duration-150 active:scale-[0.98] cursor-pointer border-none"
            >
          ...
          <div className="lg:col-span-6 p-8 rounded-3xl bg-white border border-[#E2E6EC] shadow-premium space-y-6 text-left">
            <div className="flex items-center justify-between">
              <span className="text-xs font-extrabold uppercase text-gray-400">INPUT CONTENT</span>
              <span className="text-xs font-bold text-[#14137B]">Skincare Photo</span>
            </div>
            ...
            <div className="space-y-2 p-4 rounded-2xl bg-[#F5F7FA]/70 border border-[#E2E6EC]">
              <span className="text-[10px] font-extrabold uppercase tracking-wider text-[#14137B]">
      ...
      {/* 7. FEATURE SHOWCASE */}
      <section id="features" className="py-24 bg-white border-y border-[#E2E6EC]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-24">
          
          <div className="text-center max-w-2xl mx-auto space-y-3">
            <span className="text-xs font-extrabold uppercase tracking-widest text-[#14137B]">Built For Creators</span>
          ...
          <div className="grid lg:grid-cols-12 gap-12 items-center">
            <div className="lg:col-span-5 space-y-4 text-left">
              <span className="text-xs font-extrabold text-[#14137B] uppercase">FEATURE 01</span>
            ...
            <div className="lg:col-span-7 p-6 rounded-3xl bg-[#F5F7FA] border border-[#E2E6EC]">
              <div className="grid grid-cols-3 gap-3">
                <div className="aspect-square rounded-2xl overflow-hidden bg-white border border-[#E2E6EC]">
          ...
          <div className="grid lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-5 order-1 lg:order-2 space-y-4 text-left">
              <span className="text-xs font-extrabold text-[#14137B] uppercase">FEATURE 02</span>
              <h3 className="font-display text-2xl sm:text-3xl font-black text-[#111111]">
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto text-center space-y-6">
        <div className="max-w-2xl mx-auto space-y-4">
          <div className="w-12 h-12 rounded-2xl bg-[#EDF9DC] text-[#66D100] flex items-center justify-center mx-auto border border-[#D4EFAE]">
          ...
          <div className="pt-4">
            <button
              onClick={onStartCreating}
              className="inline-flex items-center gap-2 px-8 h-13 rounded-full text-xs font-extrabold bg-[#14137B] hover:bg-[#0E0D57] text-white shadow-sm cursor-pointer border-none"
            >
      ...
      <section id="pricing" className="py-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto text-center space-y-16">
        ...
        <div className="max-w-3xl mx-auto space-y-4">
          <span className="text-xs font-extrabold uppercase tracking-widest text-[#14137B]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-left items-stretch">
          ...
          {/* PLAN 1 — FREE */}
          <div className="p-8 rounded-3xl bg-white border border-[#E2E6EC] shadow-xs flex flex-col justify-between space-y-6 hover:shadow-md transition-all">
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <h3 className="font-display text-xl font-extrabold text-[#111111]">Free</h3>
                <span className="text-[10px] font-bold uppercase tracking-wider text-gray-400 bg-[#F5F7FA] px-2.5 py-1 rounded-full border border-[#E2E6EC]">
                  Starter
                </span>
              </div>
              ...
              <div className="pt-4 border-t border-[#E2E6EC] space-y-3">
                ...
                <ul className="space-y-2.5 text-xs text-gray-700 font-medium">
                  <li className="flex items-center gap-2">
                    <CheckCircle2 className="w-4 h-4 text-[#66D100] shrink-0" />
            ...
            <button
              onClick={onStartCreating}
              className="w-full h-12 rounded-xl text-xs font-extrabold bg-[#F5F7FA] hover:bg-[#E2E6EC] text-[#111111] border border-[#E2E6EC] transition-all cursor-pointer"
            >
              Start for Free
            </button>
          </div>
          ...
          <div className="relative p-8 rounded-3xl bg-white border-2 border-[#14137B] shadow-premium flex flex-col justify-between space-y-6 transform md:-translate-y-2">
            
            {/* MOST POPULAR BADGE */}
            <div className="absolute -top-3.5 left-1/2 -translate-x-1/2 px-4 py-1 rounded-full bg-[#14137B] text-white text-[10px] font-black uppercase tracking-widest shadow-xs">
              MOST POPULAR
            </div>
            ...
            <div className="space-y-4 pt-2">
              <div className="flex items-center justify-between">
                ...
                <span className="text-[10px] font-bold uppercase tracking-wider text-[#14137B] bg-[#EDEDF8] px-2.5 py-1 rounded-full border border-[#C9C8E8]">
                  Recommended
                </span>
              </div>
              <p className="text-xs text-gray-500 leading-relaxed min-h-[36px]">
              ...
              <div className="pt-4 border-t border-[#E2E6EC] space-y-3">
                <p className="text-[10px] font-extrabold uppercase tracking-wider text-[#14137B]">EVERYTHING IN FREE, PLUS</p>
                <ul className="space-y-2.5 text-xs text-gray-800 font-medium">
                  <li className="flex items-center gap-2">
                    <CheckCircle2 className="w-4 h-4 text-[#14137B] shrink-0" />
      ...
      {/* 9. FINAL CTA SECTION */}
      <section className="py-24 bg-[#14137B] text-white text-center">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
          <LogoIcon size={48} variant="white" className="mx-auto" />
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
            <button
              onClick={onStartCreating}
              className="w-full sm:w-auto h-13 px-8 rounded-full text-xs font-extrabold bg-[#14137B] hover:bg-[#0E0D57] text-white shadow-sm cursor-pointer border-none"
            >
              Start Creating →
            </button>
            <button
      ...
      {/* 10. FOOTER */}
      <footer className="py-12 bg-[#F5F7FA] border-t border-[#E2E6EC] text-xs text-gray-500">
